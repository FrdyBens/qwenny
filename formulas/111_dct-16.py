NAME = "DCT Fit T=16"
VERSION = "1.0.0"
DESCRIPTION = ("keep 16 cosine coefficients over a 512-byte window; lossy approximation. Measures basis representation error per sample type.")
CATEGORY = "Signal"
TAGS = ["signal","lossy"]
...
T = 16   # retained coefficients
N0 = 512 # assumed period
