NAME = "Keyed XOR Words 8"
VERSION = "1.0.0"
DESCRIPTION = ("8-word PRNG key XOR; tests whether keying by content digest ever shrinks state (it cannot — measure the illusion).")
...
K = 8          # key words
G = 13787848793156543929          # mixing constant
...
def analyze(INPUT, PARAMETERS):
    ...
    import hashlib
    seed = int.from_bytes(hashlib.sha256(b"abc-keyxor-8").digest()[:8], "big")
