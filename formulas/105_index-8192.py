NAME = "Direct Index P=8192"
VERSION = "1.0.0"
DESCRIPTION = ("bit(n)=F(params,n): hash-chain of 8192 fitted params drives each bit. Tiny state => expect ~50% BER on random data; any lower BER on structured data is the signal worth studying.")
...
def analyze(INPUT, PARAMETERS):
    ...
    import hashlib
    d = hashlib.sha256(b"abc-indexlaw-8192-11").digest()
    while len(d) < P * 8:
