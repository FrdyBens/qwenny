NAME = "Keyed XOR Words 4"
VERSION = "1.0.0"
DESCRIPTION = ("4-word PRNG key XOR; tests whether keying by content digest ever shrinks state (it cannot — measure the illusion).")
...
K = 4          # key words
G = 11400714819323198485          # mixing constant
...
def analyze(INPUT, PARAMETERS):
    ...
    import hashlib
    seed = int.from_bytes(hashlib.sha256(b"abc-keyxor-4").digest()[:8], "big")
