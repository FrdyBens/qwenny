NAME = "DCT Fit T=8"
VERSION = "1.0.0"
DESCRIPTION = ("keep 8 cosine coefficients over a 256-byte window; lossy approximation. Measures basis representation error per sample type.")
CATEGORY = "Signal"
TAGS = ["signal","lossy"]
...
T = 8   # retained coefficients
N0 = 256 # assumed period
