NAME = "Direct Index P=2048"
VERSION = "1.0.0"
DESCRIPTION = ("bit(n)=F(params,n): hash-chain of 2048 fitted params drives each bit. Tiny state => expect ~50% BER on random data; any lower BER on structured data is the signal worth studying.")
...
def analyze(INPUT, PARAMETERS):
    ...
    import hashlib
    d = hashlib.sha256(b"abc-indexlaw-2048-9").digest()
    while len(d) < P * 8:
