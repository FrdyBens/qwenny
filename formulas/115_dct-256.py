NAME = "DCT Fit T=256"
VERSION = "1.0.0"
DESCRIPTION = ("keep 256 cosine coefficients over a 8192-byte window; lossy approximation. Measures basis representation error per sample type.")
CATEGORY = "Signal"
TAGS = ["signal","lossy"]
...
T = 256   # retained coefficients
N0 = 8192 # assumed period
