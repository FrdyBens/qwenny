NAME = "DCT Fit T=64"
VERSION = "1.0.0"
DESCRIPTION = ("keep 64 cosine coefficients over a 2048-byte window; lossy approximation. Measures basis representation error per sample type.")
CATEGORY = "Signal"
TAGS = ["signal","lossy"]
...
T = 64   # retained coefficients
N0 = 2048 # assumed period
