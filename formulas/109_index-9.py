NAME = "Direct Index P=9"
VERSION = "1.0.0"
DESCRIPTION = ("bit(n)=F(params,n): hash-chain of 9 fitted params drives each bit. Tiny state => expect ~50% BER on random data; any lower BER on structured data is the signal worth studying.")
