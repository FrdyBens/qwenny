NAME = "Keyed XOR Words 16"
VERSION = "1.0.0"
DESCRIPTION = ("16-word PRNG key XOR; tests whether keying by content digest ever shrinks state (it cannot — measure the illusion).")
...
K = 16          # key words
G = 10723151780598845931          # mixing constant
...
def analyze(INPUT, PARAMETERS):
    ...
    import hashlib
    seed = int.from_bytes(hashlib.sha256(b"abc-keyxor-16").digest()[:8], "big")
