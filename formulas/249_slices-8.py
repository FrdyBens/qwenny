NAME = "Bit Slice Groups 8"
VERSION = "1.0.0"
DESCRIPTION = ("transpose bits across 8-byte groups: tests bit-plane reorganization as a codec (bijection, true RA within group window).")
CATEGORY = "BitOps"
